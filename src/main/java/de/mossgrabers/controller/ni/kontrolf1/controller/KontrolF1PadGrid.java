...
/**
 * Pad grid config for Kontrol F1.
 *
 * @author Jürgen Moßgraber
 */
public class KontrolF1PadGrid extends PadGridImpl
{
    // // @formatter:off
     ...
     */
    public KontrolF1PadGrid (final ColorManager colorManager, final IMidiOutput output)
    {
        // Using default midi start note (36) (last arg).

...
/**
 * Mix mode for the LauchControl XL to control the first 3 track-level remote controls (in Bitwig 5+).
 *
 * (This is currently 100% duplicate of XLTrackMixMode).
 *
 * Next step - proof of concept:
 * - Use pan knob for remote control 1 - change value.
 * - Use pan knob for remote control 1 - show value with LED.
 *
 * @author Jürgen Moßgraber
 */
public class XLTrackRemotesMode extends XLAbstractTrackMode
{
    /**
     * Constructor.
     *
     ...
     */
    public XLTrackRemotesMode (final LaunchControlXLControlSurface surface, final IModel model, final List<ContinuousID> controls)
    {
        super ("Track Remote Controls", surface, model, controls);
